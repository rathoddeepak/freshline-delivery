    ...
    return (
      <View {...other} style={[mainStyles.container, style]} onLayout={this._measureContainer}>
        ...
        >
          ...
          {busy ? <View style={[mainStyles.thumb, {backgroundColor:'#00000099',justifyContent:'center', alignItems:'center'}]}>
           <ActivityIndicator size={THUMB_SIZE} color={thumbTintColor} />
          </View> : null}
        </Animated.View>
        <View
          renderToHardwareTextureAndroid={true}
